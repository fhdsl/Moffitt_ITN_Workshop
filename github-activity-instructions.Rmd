...
<input type="checkbox"> Ask find to create a README from the code. Copy (Ctrl + C) and paste (Ctrl + V) in the code from `01-heatmap.Rmd`. You may want to do some variations on the prompt you use to ask phind to do this to get good results.     
