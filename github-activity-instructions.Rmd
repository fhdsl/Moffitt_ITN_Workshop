...
<input type="checkbox"> Go back to GitHub Desktop. You should see `1 changed file` in the upper right corner.
...
<input type="checkbox"> Follow GitHub Desktop's prompt to `Create a Pull Request` and click the blue button.
...
<input type="checkbox"> Click `Show all checks`.  
...
<input type="checkbox"> Now your changes should be synced. Check the file you've changed to make sure.
