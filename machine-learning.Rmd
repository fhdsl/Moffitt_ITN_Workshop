...
```{r echo=FALSE, fig.alt = "Galaxy Home page", fig.link = "https://usegalaxy.org/join-training/itn-at-moffitt-2025/"}
...
```{r echo=FALSE, fig.alt = "If needed (e.g., because there are already files in your history), create a new history"}
...
```{r echo=FALSE, fig.alt = "Pencil button for renaming the history"}
...
```{r echo=FALSE, fig.alt = "Replace 'Unnamed history' with a descriptive name for the history."}
...
```{r echo=FALSE, fig.alt = "Click 'Save' to save the new history name"}
...
```{r echo=FALSE, fig.alt = "'Upload' button for data upload highlighted in the upper left corner"}
...
```{r echo=FALSE, fig.alt = "Interactive panel for data upload"}
...
```{r echo=FALSE, fig.alt = "The Paste/Fetch data button is highlighted within the bottom stretch of options"}
...
```{r echo=FALSE, fig.alt = "paste the copied URLs into the middle highlighted box"}
...
```{r echo=FALSE, fig.alt = "The 'Start' button in the middle of the bottom stretch of options is highlighted."}
...
```{r echo=FALSE, fig.alt = "The 'Close' button in the bottom stretch of options is highlighted."}
...
```{r echo=FALSE, fig.alt = "Tool search bar where to copy and paste the name of the tool 'Pycaret Model Comparison'"}
...
```{r echo=FALSE, fig.alt = "Select PyCaret Model Comparison from the options listed below the tool search bar"}
...
```{r echo=FALSE, fig.alt = "Select the training dataset for the Train Dataset option"}
...
```{r echo=FALSE, fig.alt = "Select the test dataset for the Test Dataset option"}
...
```{r echo=FALSE, fig.alt = "Select the 'Response' column as the target column"}
...
```{r echo=FALSE, fig.alt = "Verify that 'classification' is selected for the Task option"}
...
```{r echo=FALSE, fig.alt = "Select Logistic Regression, Decision Tree Classifier, and Random Forest Classifier from the list for the 'Only Select Classification Models if you do not want to compare all models option.'"}
...
```{r echo=FALSE, fig.alt = "Switch the No to Yes under the Customize Default Settings? Option"}
...
```{r echo=FALSE, fig.alt = "Switch 10 to 2 under the Cross Validation Folds option"}
...
```{r echo=FALSE, fig.alt = "Click the Run Tool button to submit the job so that pycaret will compare the classification models using the provided data"}
...
```{r echo=FALSE, fig.alt = "Use the eye icon to inspect the output"}
...
```{r echo=FALSE, fig.alt = "The output will open in the middle pane where you can inspect it. "}
