...
```
## Activity: Set Posit Cloud

For easy start up we will use Posit Cloud -- an online resource for using R.

<input type="checkbox"> If you have not already accept the invite to our Posit cloud space go to your email that you registered with and accept that invite. <br>  
...
<input type="checkbox"> Name your copy of your workspace by a name and click enter.  <br>

![Posit Set Up Steps](./resources/images/posit_setup.png)

<input type="checkbox"> Click on the gear in the corner and pick "resources" <br>
<input type="checkbox"> Use the sliders to have at least 10 GB and 2CPUs available to your project. <br>
<input type="checkbox"> Click Apply Changes <br>

![Posit Set Up Steps](./resources/images/resources_posit.png)
