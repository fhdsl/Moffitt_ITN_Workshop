...
<summary>Adding sample metadata manually</summary>
...
<summary>Additional samples in the data set</summary>
...
<summary>Loading data into the command-line version of spatialGE</summary>
...
<summary>Performing gene-level filtering</summary>
...
<details><summary>Visualizing gene counts in spatial context</summary>
...
<details><summary>Assessing data normalization results at the gene level</summary>
...
<summary>Generation of gene expression surfaces</summary>
...
<details><summary>Other analysis types to explore</summary>

We strongly encourage the users to run these more advanced analyses. These were not
...
## Spatially variable gene testing (Moran's and Geary's C)
