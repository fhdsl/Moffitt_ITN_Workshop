...
Now [return to the beginning of these steps](#uploading-one-samples-data) to repeat the same steps for the other 3 samples.
...
<input type="checkbox"> Once you have all the filter settings as you'd like cick the blue "APPLY FILTER" button.  
