...
Using the steps previsouly outlined to [detect spatial
domains](#detect-spatial-domains), it seems spatial domain 3 in the plot
with title "stclust_spw0_k3", is an immune-infiltrated area. With the
following steps, users can test for genes with spatial expression
